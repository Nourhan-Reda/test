// Living Room script.js placeholder
...
fetch("../../partials/navbar.html")
  ...
  .then(data => {
    ...
    // هنا الكود بتاعك للـ nav-link بعد ما النافبار اتضاف
...
fetch("../../json/products.json")
  ...
  .then(products => {
    ...
    const filtered = products.filter(product => product.category.startsWith("Living Room"));
